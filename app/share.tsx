...
const DEFAULT_SELECTED = new Set(['g-우리끼리', 'p-f-minji']);
...
export default function ShareScreen() {
  ...
  function handleShare() {
    ...
    shareToTargets(Array.from(selected));
    ...
    <View style={styles.screen}>
      <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
        ...
        <View style={styles.previewWrap}>
          <LinearGradient
            colors={capturedPhoto?.gradient ?? ['#6B4B96', '#2C1E4A']}
        ...
        <ScrollView contentContainerStyle={styles.list}>
          ...
          <SectionLabel style={{ marginTop: 6 }}>개인</SectionLabel>
        ...
        <View style={styles.cta}>
          <PrimaryButton onPress={handleShare} disabled={selected.size === 0} style={{ width: '100%' }}>
            공유하기
          </PrimaryButton>
        </View>
...
const styles = StyleSheet.create({
  ...
  previewWrap: { marginHorizontal: 16, height: 160, borderRadius: radius.xl, overflow: 'hidden' },
